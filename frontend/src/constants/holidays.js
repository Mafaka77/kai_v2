/**
 * Centralized Frontend Repository of Default Official & Restricted Holidays
 */
...
export const HOLIDAY_DATES_DD_MM_YYYY = DEFAULT_HOLIDAYS.map(h => {
  const [y, m, d] = h.date.split('-');
  return `${d}-${m}-${y}`;
});

export const HOLIDAY_DATES_YYYY_MM_DD = DEFAULT_HOLIDAYS.map(h => h.date);

export const PUBLIC_HOLIDAY_DATES_DD_MM_YYYY = DEFAULT_HOLIDAYS
...
export const RESTRICTED_HOLIDAY_DATES_DD_MM_YYYY = DEFAULT_HOLIDAYS
